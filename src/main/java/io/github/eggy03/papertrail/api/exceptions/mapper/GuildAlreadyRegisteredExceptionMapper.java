...
@Provider
@Slf4j
public class GuildAlreadyRegisteredExceptionMapper implements ExceptionMapper<GuildAlreadyRegisteredException> {

    @Context
    UriInfo uriInfo;

    @Override
    public Response toResponse(GuildAlreadyRegisteredException e) {
